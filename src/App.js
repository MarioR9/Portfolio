...
class App extends React.Component {
  ...
  return (
    <div className="App">
     ...
     <Projects show={this.show} show2={this.show2} show3={this.show3} handleTranslateme={this.handleTranslateme} handleRickAndMorty={this.handleRickAndMorty} handleTonester={this.handleTonester}/>
